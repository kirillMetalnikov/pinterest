  ...
  render() {
    ...
    return (
      <Card centered>
        ...
        <Card.Content>
          <Card.Header onClick = {this.hundleUser.bind(this)(ownerID)}>
            {ownerName}
          </Card.Header>
          <Card.Description>
            {description}
        ...
        <Card.Content extra>
          <Button as='div' labelPosition='right' onClick = {this.hundleLike.bind(this)(_id, ownerID)}>
            ...
            <Label as='a' basic pointing='left'>{likes}</Label>
          </Button>
          {ownerID == (curentUser && curentUser._id)
            ? <Button floated='right' onClick={this.hundleDelete.bind(this)(_id, ownerID)}>Delete</Button>
            : null
          }
        </Card.Content>
      </Card>
